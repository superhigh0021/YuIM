...
extern PROTOBUF_INTERNAL_EXPORT_LogSever_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_ErrorMsg_LogSever_2eproto;
namespace ik {
...
static void InitDefaultsLogRequest_LogSever_2eproto() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_LogRequest_LogSever_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsLogRequest_LogSever_2eproto}, {}};

static void InitDefaultsErrorMsg_LogSever_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_ErrorMsg_LogSever_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsErrorMsg_LogSever_2eproto}, {}};

static void InitDefaultsLogResponse_LogSever_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_LogResponse_LogSever_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsLogResponse_LogSever_2eproto}, {
      &scc_info_ErrorMsg_LogSever_2eproto.base,}};

void InitDefaults_LogSever_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_LogRequest_LogSever_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_ErrorMsg_LogSever_2eproto.base);
  ::google::protobuf::internal::InitSCC(&scc_info_LogResponse_LogSever_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_LogSever_2eproto[3];
constexpr ::google::protobuf::EnumDescriptor const** file_level_enum_descriptors_LogSever_2eproto = nullptr;
const ::google::protobuf::ServiceDescriptor* file_level_service_descriptors_LogSever_2eproto[1];

const ::google::protobuf::uint32 TableStruct_LogSever_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_LogSever_2eproto = {
  {}, AddDescriptors_LogSever_2eproto, "LogSever.proto", schemas,
  file_default_instances, TableStruct_LogSever_2eproto::offsets,
  file_level_metadata_LogSever_2eproto, 3, file_level_enum_descriptors_LogSever_2eproto, file_level_service_descriptors_LogSever_2eproto,
};

const char descriptor_table_protodef_LogSever_2eproto[] =
  "\n\016LogSever.proto\022\002ik\032\033google/protobuf/em"
  "pty.proto\"\'\n\nLogRequest\022\014\n\004name\030\001 \001(\014\022\013\n"
  "\003msg\030\002 \001(\014\",\n\010ErrorMsg\022\r\n\005state\030\001 \001(\010\022\021\n"
  "\terror_msg\030\002 \001(\014\"(\n\013LogResponse\022\031\n\003msg\030\001"
  " \001(\0132\014.ik.ErrorMsg2\254\001\n\014LogServerRpc\0222\n\010L"
  "og_INFO\022\016.ik.LogRequest\032\026.google.protobu"
  "f.Empty\0223\n\tLog_ERROR\022\016.ik.LogRequest\032\026.g"
  "oogle.protobuf.Empty\0223\n\tLog_FATAL\022\016.ik.L"
  "ogRequest\032\026.google.protobuf.EmptyB\003\200\001\001b\006"
  "proto3"
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_LogSever_2eproto = {
  false, InitDefaults_LogSever_2eproto, 
  descriptor_table_protodef_LogSever_2eproto,
  "LogSever.proto", &assign_descriptors_table_LogSever_2eproto, 366,
};
...
void AddDescriptors_LogSever_2eproto() {
 ...
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_LogSever_2eproto, deps, 1);
}

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_LogSever_2eproto = []() { AddDescriptors_LogSever_2eproto(); return true; }();
namespace ik {
...
void LogRequest::SharedCtor() {
  ::google::protobuf::internal::InitSCC(
      &scc_info_LogRequest_LogSever_2eproto.base);
  name_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  msg_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
::google::protobuf::Metadata LogRequest::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_LogSever_2eproto);
  return ::file_level_metadata_LogSever_2eproto[kIndexInFileMessages];
}
...
void LogResponse::SharedCtor() {
  ::google::protobuf::internal::InitSCC(
      &scc_info_LogResponse_LogSever_2eproto.base);
  msg_ = nullptr;
}
...
const ::google::protobuf::ServiceDescriptor* LogServerRpc::descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&assign_descriptors_table_LogSever_2eproto);
  return file_level_service_descriptors_LogSever_2eproto[0];
}
...
void LogServerRpc::CallMethod(const ::google::protobuf::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_LogSever_2eproto[0]);
  switch(method->index()) {
    case 0:
      Log_INFO(controller,
